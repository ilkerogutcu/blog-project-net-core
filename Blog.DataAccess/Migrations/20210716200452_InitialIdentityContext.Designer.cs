...
namespace Blog.DataAccess.Migrations
{
    ...
    [Migration("20210716200452_InitialIdentityContext")]
            ...
            modelBuilder.Entity("ApplicationUserNotification", b =>
                {
                    ...
                    b.HasKey("NotificationsId", "UsersId")
                        .HasName("pk_application_user_notification");

                    b.HasIndex("UsersId")
                        .HasDatabaseName("ix_application_user_notification_users_id");

                    b.ToTable("application_user_notification");
                });

            modelBuilder.Entity("Blog.Entities.Concrete.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Blog.Entities.Concrete.Topic", b =>
                {
                    ...
                    b.HasIndex("ImageId")
                        .HasDatabaseName("ix_topics_image_id");
            ...
            modelBuilder.Entity("ApplicationUserNotification", b =>
                {
                    b.HasOne("Blog.Entities.Concrete.Notification", null)
                        ...
                        .HasConstraintName("fk_application_user_notification_notifications_notifications_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blog.Entities.Concrete.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UsersId")
                        .HasConstraintName("fk_application_user_notification_users_users_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Blog.Entities.Concrete.Post", b =>
                {
                    ...
                    b.HasOne("Blog.Entities.Concrete.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Blog.Entities.Concrete.Topic", b =>
                {
                    b.HasOne("Blog.Entities.Concrete.Image", "Image")
                        .WithMany()
                        .HasForeignKey("ImageId")
                        .HasConstraintName("fk_topics_images_image_id");
            ...
            modelBuilder.Entity("PostTopic", b =>
                {
                    ...
                    b.HasOne("Blog.Entities.Concrete.Topic", null)
                        .WithMany()
